...
<div class="wrapper">
        ...
        <section class="news-content">
            <div class="container">
                ...
                <div class="article">
                    <h2 class="py-2">${viewForm.newsAreaBean.title}</h2>
                    <!-- 暫時先不放標題圖片 0918 
                    <img src="${viewForm.newsAreaBean.url}" alt="" title="" class="img-fluid py-3">
                    -->
                    <br>
                    
                    ${viewForm.newsAreaBean.content}
                ...
                <div class="text-center article-button">
                    <button type="button" class="btn btn-primary" onclick="location.href='${contextPath}/newsArea';">回上一頁</button>
                </div>
            </div>
        </section>
        <!-- /new article end -->
