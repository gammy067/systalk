package com.systalk.sys.auth.model;
...
/**
 * 此model因應於google認證後,在db不存密碼,所以在create instance時,不檢查密碼是否為空
 * 參考自{@link org.springframework.security.core.userdetails.User}
 * 
 * @author jaychen
 *
 */
public class CustomUserDetails implements UserDetails {
	...
	private static final long serialVersionUID = 2302235454761938000L;
