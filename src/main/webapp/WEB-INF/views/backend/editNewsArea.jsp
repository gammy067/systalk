...
<style>
		...
		*/
		...
		var callUploadFunction = function(file,type,callback){
			...
			$.ajax({
				...
				success: function (imageUrl) {
					// var data = decodeURIComponent(imageUrl);
					//callback(data.uriLink);
					
					callback(decodeURIComponent(imageUrl));
				},
		...
		tinymce.init({
		    ...
		    images_upload_handler: function (blobInfo, success, failure) {
				...
				init_instance_callback:function(){
					tinyMCE.get('editContent').setContent("${viewForm.uploadFileForm.content}");
					//getEditorContent();
			}
		});
		...
		tinymce.init({
		    ...
		    images_upload_handler: function (blobInfo, success, failure) {
				...
				init_instance_callback:function(){
					tinyMCE.get('editContentEn').setContent("${viewForm.uploadFileForm.contentEn}");
					//getEditorContent();
			}
		});
	...
	function saveAction() {
		...
		var contentEn = tinyMCE.get('editContentEn').getContent();
            ...
            <div class="about-box row mx-auto">
                ...
                <div class="col-md-12">
                    <div class="setting input-type mt-4">
						...
						<sf:input type="hidden" id="contentEn" name="contentEn" path="uploadFileForm.contentEn" />
                           ...
                           <sf:errors path="uploadFileForm.titleEn" cssClass="text-red" />
                            <div class="news-title">
                                <div class="setting-line"><span class="text-grey">英文標題</span>
                                	<sf:input type="text" class="mx-auto " path="uploadFileForm.titleEn" placeholder="請輸入標題(建議字數20字以內)" />
                                </div>
                            </div>
                            
                            <div class="news-sort">
                                <div class="setting-line news-sort"><span class="text-grey">中文分類</span>
                                    <div class="status">
		                        		<sf:select path="typeSeq" class="filter combo" >
                            ...
                            <div class="news-sort">
                               <div class="setting-line news-sort"><span class="text-grey">英文分類</span>
                                    <div class="status">
		                        		<sf:select path="typeSeqEn" class="filter combo" >
		   									<sf:options items="${viewForm.typeComboEn.options}" itemValue="value" itemLabel="label" />
										</sf:select>
                                    </div>
                                </div>
                            </div>
	                ...
	                <ul class="nav nav-tabs success-tabs">
	                    ...
	                    <li class="nav-item">
	                        <a class="nav-link active tabls-left" data-toggle="tab" href="#zh_Content">中文</a>
	                    </li>

	                    <li class="nav-item">
	                        <a class="nav-link tabls-right" data-toggle="tab" href="#en_Content">英文</a>
	                    </li>
	                     <!-- 編輯器錯誤訊息 -->
	                ...
	                <div class="tab-content w-100">
	                    <div class="tab-pane container active" id="zh_Content">
	                    ...
	                    <div class="tab-pane container" id="en_Content">
	                    
							<!-- 英文編輯器位置 -->
							<div class="col-md-12 text-center">
								<div class="place-tit" id="editContentEn"></div>
							</div>
	                    </div>
	                </div>
